...
#
# Created: Sun Jun 07 18:00:14 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_9 = QtGui.QVBoxLayout(self.page2)
        ...
        self.verticalLayout_9.addWidget(self.db_tree)
        ...
        self.menuSave.addAction(self.actionSpecifications)
        self.menuSave.addAction(self.actionDatabases)
        self.menuSave.addAction(self.actionModels)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.table3.horizontalHeaderItem(2).setText(QtGui.QApplication.translate("MainWindow", "Specification", None, QtGui.QApplication.UnicodeUTF8))
        self.table3.horizontalHeaderItem(3).setText(QtGui.QApplication.translate("MainWindow", "Db", None, QtGui.QApplication.UnicodeUTF8))
        self.table3.horizontalHeaderItem(4).setText(QtGui.QApplication.translate("MainWindow", "Model", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.table4.horizontalHeaderItem(1).setText(QtGui.QApplication.translate("MainWindow", "Revision", None, QtGui.QApplication.UnicodeUTF8))
        self.tabs.setTabText(self.tabs.indexOf(self.tab4), QtGui.QApplication.translate("MainWindow", "Handlers", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.tab5), QtGui.QApplication.translate("MainWindow", "Specifications", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.table6.horizontalHeaderItem(1).setText(QtGui.QApplication.translate("MainWindow", "Type", None, QtGui.QApplication.UnicodeUTF8))
        self.table6.horizontalHeaderItem(2).setText(QtGui.QApplication.translate("MainWindow", "Db", None, QtGui.QApplication.UnicodeUTF8))
        self.table6.horizontalHeaderItem(3).setText(QtGui.QApplication.translate("MainWindow", "Url", None, QtGui.QApplication.UnicodeUTF8))
        self.table6.horizontalHeaderItem(4).setText(QtGui.QApplication.translate("MainWindow", "User", None, QtGui.QApplication.UnicodeUTF8))
        self.table6.horizontalHeaderItem(5).setText(QtGui.QApplication.translate("MainWindow", "Password", None, QtGui.QApplication.UnicodeUTF8))
        self.tabs.setTabText(self.tabs.indexOf(self.tab6), QtGui.QApplication.translate("MainWindow", "Databases", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.table7.horizontalHeaderItem(1).setText(QtGui.QApplication.translate("MainWindow", "Revision", None, QtGui.QApplication.UnicodeUTF8))
        self.tabs.setTabText(self.tabs.indexOf(self.tab7), QtGui.QApplication.translate("MainWindow", "Models", None, QtGui.QApplication.UnicodeUTF8))
