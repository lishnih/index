...
from ....lib.db import link_objects
...
def parse_doc(sh, doc_options, session, models, marks_dict, SHEET):
    ...
    # Plains
    for plain_list in doc_plains:
        key, value = plain_list
        doc_dict[key] = value
        ...
        for doc_object in doc_objects:
            try:
                ...
                if hasattr(OBJECT, 'tree_item'):
                    OBJECT.tree_item.setBrief(doc_plain)
            ...
            if row_dict:
                ...
                for table_object in table_objects:
                    try:
                        ...
                        if hasattr(OBJECT, 'tree_item'):
                            OBJECT.tree_item.setBrief(test)
                ...
                for table_object in table_objects1:
                    try:
                        ...
                        OBJECT = reg_object1(session, Object, row_dict, TABLE, required=required, keys=keys)
                        ROWS.append(OBJECT)
